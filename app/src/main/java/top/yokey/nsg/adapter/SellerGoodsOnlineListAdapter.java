...
public class SellerGoodsOnlineListAdapter extends RecyclerView.Adapter<SellerGoodsOnlineListAdapter.ViewHolder> {

    private Activity mActivity;
    private NcApplication mApplication;
    private ArrayList<HashMap<String, String>> mArrayList;

    public SellerGoodsOnlineListAdapter(NcApplication application, Activity activity, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.downButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DialogUtil.query(mActivity, "确认您的选择", "下架这个商品", new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        DialogUtil.cancel();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup group, int viewType) {
        View view = LayoutInflater.from(group.getContext()).inflate(R.layout.item_list_seller_goods_online, group, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            downButton = (FloatingActionButton) view.findViewById(R.id.downButton);
