...
public class MinePayPassActivity extends AppCompatActivity {
    ...
    private void getMobileCode() {
        ...
        ajaxParams.putOp("modify_paypwd_step2");
    ...
    private void verifyCode() {
        ...
        KeyAjaxParams ajaxParams = new KeyAjaxParams(mApplication);
        ajaxParams.putAct("member_account");
        ajaxParams.putOp("modify_paypwd_step3");
    ...
    private void checkPower() {
        ...
        String params = "act=member_account&op=modify_paypwd_step4&key=" + mApplication.userKeyString;
    ...
    private void modifyPass() {
        ...
        KeyAjaxParams ajaxParams = new KeyAjaxParams(mApplication);
        ajaxParams.putAct("member_account");
        ajaxParams.putOp("modify_paypwd_step5");
        ...
        mApplication.mFinalHttp.post(mApplication.apiUrlString, ajaxParams, new AjaxCallBack<Object>() {
            ...
            public void onSuccess(Object o) {
                ...
                if (mApplication.getJsonSuccess(o.toString())) {
                    ToastUtil.showSuccess(mActivity);
                    mApplication.userHashMap.put("member_paypwd", "password");
