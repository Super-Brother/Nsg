...
* 网址：www.yokey.top
*
* 作用：主 Activity 下面包含 HomeActivity,CategoryActivity,CartActivity,MineActivity
*
*/
...
public class MainActivity extends CheckActivity {
    ...
    private void initView() {
        ...
        mTextView[2] = (TextView) findViewById(R.id.circleTextView);
    ...
    private void initData() {
        ...
        mInt[0][2] = R.mipmap.ic_nav_main_circle;
        ...
        mInt[1][2] = R.mipmap.ic_nav_main_circle_press;
        ...
        mTabHost.addTab(mTabHost.newTabSpec("Circle").setIndicator("Circle").setContent(new Intent(mActivity, CircleActivity.class)));
