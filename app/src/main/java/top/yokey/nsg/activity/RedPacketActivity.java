...
import top.yokey.nsg.adapter.RedPacketListAdapter;
...
public class RedPacketActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        titleTextView.setText("红包");

        mArrayList = new ArrayList<>();
        mAdapter = new RedPacketListAdapter(mApplication, mActivity, mArrayList);
    ...
    private void initEven() {
        ...
        tipsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tipsTextView.getText().toString().equals("读取红包数据失败\n\n点击重试")) {
                    getJson();
                }
            }
        });
