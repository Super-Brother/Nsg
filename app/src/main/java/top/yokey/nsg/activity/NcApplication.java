...
public class NcApplication extends Application {
    ...
    public ArrayList<HashMap<String, String>> voucherArrayList; //代金券数组
    public ArrayList<HashMap<String, String>> redPackArrayList; //红包数组
    ...
    */
    ...
    /*
    * 作用：开始一个 Activity 并检测是否已登录成功且带返回值
    * 更新：2016-04-02
    */
